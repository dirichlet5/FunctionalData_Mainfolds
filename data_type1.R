...
n <- 500 # 样本量
# outlier_n <- 20 # 异常值的百分比：0.04, 0.08, 0.12, 0.16, 2
m <- 51
...
data_type1 <- function(para_k, outlier_n) {
  ...
  # 异常添加方式1（方差乘以k）：
  outlier_1 <- MakeSphericalOutlier(outlier_n, mu, pts,
    K = K,
    lambda = 0.07^(seq_len(K) / 2),
    basisType = "legendre01",
    sigma2 = sigma2,
